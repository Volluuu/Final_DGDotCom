...
const EventBanner = (props) => {
 const {type} = props
    const data = {
        ...
        second : {img : "https://kream-phinf.pstatic.net/MjAyMjExMjhfMjk4/MDAxNjY5NjI1MjMzNzY2.Dxuop5dHN8qTPjJxVcAmxpoXmzPgymt3_Ynn4iLiLh0g.69CMFunDmEqTN886glOXwKLb1R8aoxfEJGfA6UaHf8gg.JPEG/a_14a4f8d840544d02a54b144749e5ae75.jpg?type=m_2560",
            title:"A.P.C. 가방 모음",
    ...
    return (
        <div>
            <Banner style={{height:"480px", display:"flex", justifyContent:"center", backgroundColor:myType.backgroundColor}}>
            ...
            <List>
                {myType.num.map((elt, idx)=><ProductElement key={idx} type={"big"} num={elt}/>
                )}
            </List>
        </div>
    );
