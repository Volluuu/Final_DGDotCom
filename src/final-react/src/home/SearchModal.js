...
export default function TransitionsModal() {
  ...
  const onSubmit = useCallback(
    (e) => {
      ...
      if (word === "") {
        ...
        axios
          .post(`${process.env.REACT_APP_URL}/list/keyword?word=${word}`)
          .then((res) => {});
        setOpen(false);
        setWord("");
      }
  ...
  const updateLatest = async () => {
    ...
    const res = await axios.get(
      `${process.env.REACT_APP_URL}/list/latest/get?num=${num}`
    );
    setLatest(res.data);
  };
  const concatLatest = async () => {
    const num = sessionStorage.u_num;
    await axios.post(
      `${process.env.REACT_APP_URL}/list/latest/update?num=${num}&word=${word}`
    );
  };
  ...
  const deleteLatest = async () => {
    const num = sessionStorage.u_num;
    await axios
      .post(`${process.env.REACT_APP_URL}/list/latest/delete?num=${num}`)
      .then();
  };
  const updateWord = async () => {
    await axios
      .get(`${process.env.REACT_APP_URL}/list/search?word=${word}`)
      .then((res) => {
