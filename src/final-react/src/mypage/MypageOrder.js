...
function MypageOrder(props) {
    ...
    console.log("data:" + JSON.stringify(tradeData));
    ...
    const onReviewModal = (p_num) => {
        let reviewModalUrl =
            process.env.REACT_APP_URL + "/mypage/reviewmodal?p_num=" + p_num;
        axios
            .get(reviewModalUrl, {
                headers: {Authorization: `Bearer ${localStorage.accessToken}`},
            })
    ...
    return (
        <div data-v-39b2348a="" className="content_area">
            <div className="my_purchase">
                ...
                {tradeData.u_name && tradeData.u_name} 님의 주문내역을 한 눈에
                볼 수 있습니다!
              </span>
                        </h3>
                    </div>
                        ...
                        <div className="period_calendar">
                            ...
                            >
                                <input
                                    ...
                                    defaultValue={
                                        tradeData.minDate && tradeData.minDate.slice(0, 10)
                                    }
                                    value={startDate}
                                    min={tradeData.minDate && tradeData.minDate.slice(0, 10)}
                                    max={endDate}
                                />
                            </div>
                    ...
                    <div data-v-f263fda4="">
                        ...
                        >
                            ...
                            >
                                ...
                                <b style={{paddingTop: "6px"}}>주문번호</b>
                                <b style={{paddingTop: "6px"}}>배송상태</b>
                                <b style={{paddingTop: "6px"}}>후기</b>
                            ...
                            >
                                ...
                                <div style={{gridColumn: "1/7", gridRow: "14/15"}}>
                                    {tradeData && tradeData.startPage > 1 ? (
                                        <Link
                                            className={"pagenum"}
                                            to={`/mypage/order/${tradeData.startPage - 1}`}
                                        >
                                    ...
                                    {tradeData.pidx &&
                                        tradeData.pidx.map((n, i) => (
                                            <NavLink
                                                ...
                                                className={"pagenum"}
                                                style={{
                                                    color: n === Number(currentPage) ? "red" : "blue",
                                                }}
                                                to={`/mypage/order/${n}`}
                                            >
                                                <b>{n}</b>
                                    ...
                                    {tradeData && tradeData.endPage < tradeData.totalPage ? (
                                        <Link
                                            className={"pagenum"}
                                            to={`/mypage/order/${tradeData.endPage + 1}`}
                                        >
                ...
                <ul data-v-a54c4c26="" className="search_info">
                    <li data-v-a54c4c26="" className="info_item">
                        <p data-v-a54c4c26="">첫 주문 일자 이후부터 조회 가능합니다.</p>
                    </li>
                    <li data-v-a54c4c26="" className="info_item">
                        <p data-v-a54c4c26="">주문 내역은 최근 날짜 기준으로 노출됩니다.</p>
                    </li>
                    <li data-v-a54c4c26="" className="info_item">
                        <p data-v-a54c4c26="">후기 작성 시 1,000P를 지급해드립니다.</p>
                    </li>
                </ul>
                            ...
                            >
                                ...
                                >
                                    <h3 data-v-28cabbb5="" data-v-1f7c6d3f="" className="title">
                                        <img
                                            alt={""}
                                            src={productUrl + productDto.photo}
