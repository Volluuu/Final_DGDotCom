            ...
            >
              ...
              >
                ...
                <div data-v-3b925b8c="" className="product_info">
                  <div data-v-3b925b8c="" className="title">
                    <p data-v-3b925b8c="" className="brand">
                      {item.brand}
                    </p>
                    <p data-v-3b925b8c="" className="translated_name">
                      {item.p_name}
                    </p>
                  </div>
                  ...
                  <div data-v-3b925b8c="" className="price">
                    <div data-v-3b925b8c="" className="amount">
                      <span data-v-3b925b8c="" className="discount_rate">{`${
                        item.discount === 0 ? "" : item.discount + "% 할인"
                      }`}</span>{" "}
                      {item.price
                        .toString()
                        .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
              ...
              <div data-v-3b925b8c="" className="interest_figure">
                <span data-v-3b925b8c="" className="wish_figure">
                  <Link
                    data-v-150a7ea0=""
                    data-v-3b925b8c=""
                    to="#"
                    ...
                    className="btn_wish"
                  >
                    {/*    아이콘 들어갈 자리 href 수정 */}별
                  </Link>
                  <span data-v-3b925b8c="" className="text">
                    0
                  </span>
                </span>
                <span data-v-3b925b8c="" className="review_figure">
                  <Link
                    data-v-3b925b8c=""
                    to={`/product/detail/${item.p_num}`}
