        ...
        <div data-v-f263fda4="" data-v-39b2348a="" className="content_area">
            {
                ...
                <div data-v-f263fda4="" className="my_home">
                    <div data-v-5acef129="" data-v-f263fda4="" className="user_membership">
                        <div data-v-5acef129="" className="user_detail">
                            <div data-v-5acef129="" className="user_thumb">
                                <img data-v-5acef129="" src="/_nuxt/img/blank_profile.4347742.png" alt="사용자 이미지"
                                     className="thumb_img"/>
                            </div>
                            <div data-v-5acef129="" className="user_info">
                                <div data-v-5acef129="" className="info_box">
                                    ...
                                    <strong data-v-5acef129="" className="name">
                                        {`${userDto.u_name} ${userDto.isadmin === "ADMIN" ? "관리자" : "고객님 정보"}`}
                                    </strong>
                                    {/* 이메일 */}
                                    ...
                                    {/* 프로필 버튼 */}
                                    <Link data-v-3d1bcc82="" data-v-5acef129="" to="/mypage/profile"
                                          className="btn btn outlinegrey small" type="button">
                                        프로필 수정
                                    </Link>
                                </div>
                            </div>
                        ...
                        <div data-v-5acef129="" className="membership_detail">
                            {/* 고객 권한, 가입일 */}
                            <Link data-v-5acef129="" to="#!" className="membership_item disabled">
                            ...
                            <Link data-v-5acef129="" to="#!" className="membership_item"
                                ...
                                <strong data-v-5acef129="" className="info">
                                    {userDto.point.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}P
                                </strong>
                                <p data-v-5acef129="" className="title"> 적립금 </p>
                            </Link>
                        </div>
                    </div>
                    <div data-v-f263fda4="" className="inventory_box">
                        <div data-v-77bfdc51="" data-v-f263fda4="">
                            <div data-v-6752ceb2="" data-v-77bfdc51="" className="my_home_title">
                                <h3 data-v-6752ceb2="" className="title">
                                    주문 내역
                                </h3>
                                <Link data-v-6752ceb2="" to="/mypage/order" className="btn_more">
                                ...
                                <div data-v-77bfdc51="" className="tab_item">
                                    <Link data-v-77bfdc51="" to="#!" className="tab_link">
                                        <dl data-v-77bfdc51="" className="tab_box">
                                            ...
                                            <dd data-v-77bfdc51="" className="count"
                                                style={{color: "#31B46E"}}>
                                        ...
                                        <div data-v-50c8b1d2="" data-v-f263fda4="" className="purchase_list all bid">
                                            <div data-v-541a17ff="" data-v-50c8b1d2="" className="empty_area">
                                                ...
                                                <Link data-v-3d1bcc82="" data-v-541a17ff="" to="/product/list/1"
                                                      className="btn outlinegrey small"> SHOP 바로가기 </Link>
                                            </div>
                                        </div>
                                    </div>
                                    :
                                                    ...
                                                    tradeData.joined.slice(0, 5).map((jitem, idx) => (
                                                        <React.Fragment key={idx}>
                                                            ...
                                                            <span style={{textAlign: "right"}}>
                                                                {(jitem.lastprice * jitem.count).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}원
                                                            </span>
                                                            <span
                                                                style={{color: jitem.state === "배송 전" ? "#FF0000" : jitem.state === "배송 중" ? "#0000FF" : "#A020F0"}}>
                                                                {jitem.state}
                                                            </span>
                                                        </React.Fragment>
                                                    ))
                    ...
                    <div data-v-6752ceb2="" data-v-f263fda4="" className="my_home_title">
                        <h3 data-v-6752ceb2="" className="title"> 장바구니 </h3>
                    ...
                    <div data-v-f263fda4="" className="recent_purchase">
                        ...
                        <div data-v-50c8b1d2="" data-v-f263fda4="" className="purchase_list all ask">
                            <div data-v-541a17ff="" data-v-50c8b1d2="" className="empty_area">
                                <p data-v-541a17ff="" className="desc"> 장바구니가 비어 있습니다.</p>
                                <Link data-v-3d1bcc82="" data-v-541a17ff="" to="/product/list/1"
                                      className="btn outlinegrey small"> SHOP 바로가기 </Link>
                            </div>
                        </div>
                    ...
                    <div data-v-1f7c6d3f="" data-v-28cabbb5="" data-v-f263fda4="" className="layer_point layer lg"
                        ...
                        <div data-v-1f7c6d3f="" className="layer_container">
                            <div data-v-1f7c6d3f="" className="layer_header">
                                <h2 data-v-28cabbb5="" data-v-1f7c6d3f="" className="title">적립금 이용안내</h2>
                            </div>
                            <div data-v-1f7c6d3f="" className="layer_content">
                                <div data-v-28cabbb5="" data-v-1f7c6d3f="" className="usable_wrap">
                                    <div data-v-28cabbb5="" data-v-1f7c6d3f="" className="usable_point">
                                        <h3 data-v-28cabbb5="" data-v-1f7c6d3f="" className="title">사용 가능한 포인트</h3>
                                        <p data-v-28cabbb5="" data-v-1f7c6d3f="" className="point_box">
                                            <span data-v-28cabbb5="" data-v-1f7c6d3f="" className="point">
                                                {userDto.point.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                            </span>
                                            <span data-v-28cabbb5="" data-v-1f7c6d3f="" className="unit">P</span>
                                        </p>
                                        <div data-v-28cabbb5="" data-v-1f7c6d3f="" className="point_info">
                                            <p data-v-28cabbb5="" data-v-1f7c6d3f="" className="info_item">
                                ...
                                <div data-v-28cabbb5="" data-v-1f7c6d3f="" className="layer_btn">
                                    <Link data-v-3d1bcc82="" data-v-28cabbb5="" to="#!" className="btn outline medium"
                                          data-v-1f7c6d3f="" onClick={() => setPointStyle("none")}> 확인 </Link>
                                </div>
                            </div>
                            <Link data-v-28cabbb5="" data-v-1f7c6d3f="" to="#!" className="btn_layer_close"
                                  onClick={() => setPointStyle("none")}> <Close/> </Link>
                        </div>
                    </div>
                </div>
            }
