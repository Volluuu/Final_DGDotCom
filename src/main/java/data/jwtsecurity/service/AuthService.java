...
import data.jwtsecurity.repository.MemberRepository;
import data.jwtsecurity.repository.RefreshTokenRepository;
...
public class AuthService {
    ...
    public TokenDto login(MemberRequestDto memberRequestDto) {
        ...
        System.out.println(memberRequestDto.toAuthentication().getAuthorities());
